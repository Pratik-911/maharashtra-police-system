...
<div class="main-content">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-user-edit"></i> अधिकारी संपादित करा
        </h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('station/officers/update/' . $officer['id']) ?>" method="post">
                <?= csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="rank" name="rank" required>
                                ...
                                <option value="असिस्टंट सब इन्स्पेक्टर" <?= old('rank', $officer['rank']) == 'असिस्टंट सब इन्स्पेक्टर' ? 'selected' : '' ?>>असिस्टंट सब इन्स्पेक्टर</option>
                                <option value="सब इन्स्पेक्टर" <?= old('rank', $officer['rank']) == 'सब इन्स्पेक्टर' ? 'selected' : '' ?>>सब इन्स्पेक्टर</option>
                                <option value="इन्स्पेक्टर" <?= old('rank', $officer['rank']) == 'इन्स्पेक्टर' ? 'selected' : '' ?>>इन्स्पेक्टर</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-text">पासवर्ड बदलायचा नसेल तर रिकामे ठेवा</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-text">स्टेशन बदलता येत नाही</div>
                        </div>
                    </div>
                </div>
